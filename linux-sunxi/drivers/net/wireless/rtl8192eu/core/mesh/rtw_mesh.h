...
int rtw_bss_is_candidate_mesh_peer(WLAN_BSSID_EX *self, WLAN_BSSID_EX *target);
int rtw_bss_is_candidate_mesh_peer_and_same_ch(WLAN_BSSID_EX *self, WLAN_BSSID_EX *target);

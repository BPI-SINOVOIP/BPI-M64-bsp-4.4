...
typedef struct __CCMU_MEDIA_PLL {
	...
	/* bit30, control mode, 0-controled by cpu, 1-control by DE */
	__u32 CtlMode:1;
...
typedef union {
	__u32 dwval;
	struct {
		/* bit0,  AXI0 clock divide ratio, 000-1, 001-2, 010-3, 011-4 */
		__u32 AXIClkDiv:2;
		/* bit2,  reserved */
		__u32 reserved0:10;
		/* bit12, CPU0/1/2/3 clock source select, 0-HOSC, 1-PLL_C0CPUX */
		__u32 CpuClkSrc:1;
		/* bit13, reserved */
		__u32 reserved1:3;
		/* bit16, AXI1 clock divide ratio, 000-1, 001-2, 010-3, 011-4 */
		__u32 AXI1ClkDiv:2;
		/* bit18,  reserved */
		__u32 reserved2:10;
		/* bit28, CPU1/1/2/3 clock source select, 0-HOSC, 1-PLL_C1CPUX */
		__u32 C1ClkSrc:1;
		/* bit29, reserved */
		__u32 reserved3:3;
	} bits;
...
typedef struct __CCMU_AHB1_RATIO_REG0054 {
	...
	/* bit8,  apb1 clock divide ratio 1/2/3/4, source is ahb1 */
	__u32 Apb1Div:2;
	__u32 reserved1:2;	/* bit10, reserved */
	/* bit12, ahb1 clock source select, 00-LOSC, 01-OSC24M, 10/11-PLL6/ahb1_pre_div */
	__u32 Ahb1ClkSrc:2;
...
typedef struct __CCMU_REG_LIST {
	/* 0x0000, PLL cluster 0 cpux control */
	volatile __ccmu_pll1_reg0000_t Pll1Ctl;
	...
	/* 0x0050, system clock divide ratio, cpu axi */
	volatile __ccmu_sysclk_ratio_reg0050_t SysClkDiv;
	/* 0x0054, ahb1/apb1 clock divide ratio */
	volatile __ccmu_ahb1_ratio_reg0054_t Ahb1Div;
	/* 0x0058, apb2 clock divide ratio */
	volatile __ccmu_apb2_ratio_reg0058_t Apb2Div;
	/* 0x005c, ahb2 clk cfg, usb and gmac option src */
	volatile __u32 Ahb2Cfg;
	...
	/* 0x01C0, cir tx, notice: cir is not existed actually.! */
	volatile __ccmu_plllock_reg0200_t PllLock;
	...
	/* 0x02a8, pll video0 reg1 pattern */
	volatile __u32 PllVideo0Reg1Pattern;

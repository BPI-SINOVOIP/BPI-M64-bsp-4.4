/*
 * drivers/soc/sunxi/pm_legacy/mem_clk.c
 *
...
__s32 mem_clk_set_misc(struct clk_misc_t *clk_misc)
{
	...
	/* 0x228,  pll vedio bias reg */
	muReg->PllVedioBias = clk_misc->PllVedioBias;
	/* 0x22c,  pll ve    bias reg */
	CmuReg->PllVeBias = clk_misc->PllVeBias;
	/* 0x288,  pll vedio pattern reg */
	CmuReg->PllVedioPattern = clk_misc->PllVedioPattern;
	/* 0x28c,  pll ve    pattern reg */
	CmuReg->PllVePattern = clk_misc->PllVePattern;
	...
	/* 0x228,  pll vedio bias reg */
	CmuReg->PllVideo0Bias = clk_misc->PllVideo0Bias;
	/* 0x22c,  pll ve    bias reg */
	CmuReg->PllVeBias = clk_misc->PllVeBias;
	/* 0x234, pll periph bias */
	CmuReg->PllPeriphBias = clk_misc->PllPeriphBias;
	/* 0x288,  pll vedio pattern reg */
	CmuReg->PllVideo0Reg0Pattern = clk_misc->PllVideo0Reg0Pattern;
	/* 0x288,  pll vedio pattern reg */
	CmuReg->PllVideo0Reg1Pattern = clk_misc->PllVideo0Reg1Pattern;
	CmuReg->Pll3Ctl = clk_misc->Pll3Ctl;	/* 0x10, vedio */
	CmuReg->Pll4Ctl = clk_misc->Pll4Ctl;	/* 0x18, ve */
	CmuReg->Pll6Ctl = clk_misc->Pll6Ctl;	/* 0x28, pll periph ctrl */
	/* 0x58, apb2 divide ratio */
	*(volatile __u32 *)(&CmuReg->Apb2Div) = clk_misc->Apb2Div;
#endif
	...
	CmuReg->PllVideo0Reg0Pattern = clk_misc->PllVideo0Reg0Pattern;
	/* 0x288,  pll vedio pattern reg */
	CmuReg->PllDePattern = clk_misc->PllDePattern;
	CmuReg->Pll3Ctl = clk_misc->Pll3Ctl;	/* 0x10, vedio */
	CmuReg->Pll4Ctl = clk_misc->Pll4Ctl;	/* 0x18, ve */
	CmuReg->Pll6Ctl = clk_misc->Pll6Ctl;	/* 0x28, pll periph ctrl */
	/* 0x58, apb2 divide ratio */
...
__s32 mem_clk_get_misc(struct clk_misc_t *clk_misc)
{
	...
	/* 0x228,  pll video bias reg */
	clk_misc->PllVideo0Bias = CmuReg->PllVideo0Bias;
	/* 0x22c,  pll ve    bias reg */
	clk_misc->PllVeBias = CmuReg->PllVeBias;
	/* 0x288,  pll video pattern reg */
	clk_misc->PllVideo0Reg0Pattern = CmuReg->PllVideo0Reg0Pattern;
	/* 0x288,  pll video pattern reg */
	clk_misc->PllVideo0Reg1Pattern = CmuReg->PllVideo0Reg1Pattern;
	clk_misc->Pll3Ctl = CmuReg->Pll3Ctl;	/* 0x10, video */
	clk_misc->Pll4Ctl = CmuReg->Pll4Ctl;	/* 0x18, ve */
	/* 0x234, pll periph bias */
	clk_misc->PllPeriphBias = CmuReg->PllPeriphBias;
	clk_misc->Pll6Ctl = CmuReg->Pll6Ctl;	/* 0x28, pll periph ctrl */
	/* 0x58, apb2 divide ratio */
	clk_misc->Apb2Div = *(volatile __u32 *)(&CmuReg->Apb2Div);
#endif
	...
	clk_misc->PllVideo0Reg0Pattern = CmuReg->PllVideo0Reg0Pattern;
	/* 0x288,  pll video pattern reg */
	clk_misc->PllDePattern = CmuReg->PllDePattern;
	clk_misc->Pll3Ctl = CmuReg->Pll3Ctl;	/* 0x10, video */
	clk_misc->Pll4Ctl = CmuReg->Pll4Ctl;	/* 0x18, ve */
	/* 0x234, pll periph bias */
	clk_misc->PllPeriphBias = CmuReg->PllPeriphBias;
	clk_misc->Pll6Ctl = CmuReg->Pll6Ctl;	/* 0x28, pll periph ctrl */
	/* 0x234, pll periph bias */
	clk_misc->PllPeriph1Bias = CmuReg->PllPeriph1Bias;
...
#ifdef CONFIG_ARCH_SUN8IW5P1
	/* 0x228,  pll vedio bias reg */
	clk_misc->PllVedioBias = CmuReg->PllVedioBias;
	/* 0x22c,  pll ve    bias reg */
	clk_misc->PllVeBias = CmuReg->PllVeBias;
	/* 0x288,  pll vedio pattern reg */
	clk_misc->PllVedioPattern = CmuReg->PllVedioPattern;
	/* 0x28c,  pll ve    pattern reg */
	clk_misc->PllVePattern = CmuReg->PllVePattern;
...
static __s32 setting_ahb0_para(void)
{
	...
	*(volatile __u32 *)(P0_ZQ0CR + 0x1000) = reg_val;
	...
	reg_val &= ~(0xfff << 16);
	/* correspond to AHB 60MHz, DRAM 800MHz, 0x10 margin */
	reg_val |= (0x40 << 16);
...
__s32 mem_clk_save(struct clk_state *ccm_reg)
{
	...
	/* ccm_reg->ccm_reg_backup.Pll_C0_Bias.dwval
	 * = ccm_reg->ccm_reg->Pll_C0_Bias.dwval           ; */
	...
	/* ccm_reg->ccm_reg_backup.Pll_Ddr_Bias.dwval
	 * = ccm_reg->ccm_reg->Pll_Ddr_Bias.dwval          ; */
	...
	/* ccm_reg->ccm_reg_backup.Pll_C0_Tun.dwval
	 * = ccm_reg->ccm_reg->Pll_C0_Tun.dwval            ; */
	...
	/* ccm_reg->ccm_reg_backup.Pll_Ddr_Pat_Cfg.dwval
	 * = ccm_reg->ccm_reg->Pll_Ddr_Pat_Cfg.dwval       ; */
	...
	/* ccm_reg->ccm_reg_backup.Pll_Ddr_Cfg.dwval
	 * = ccm_reg->ccm_reg->Pll_Ddr_Cfg.dwval           ; */
...
__s32 mem_clk_restore(struct clk_state *ccm_reg)
{
   ...
   ** reason: pll src need be ready before restore cci,gtbus,ahb... bus src.
	...
	/* 24*20/2 = 240M; */
	ccm_reg->ccm_reg->Pll_Periph2_Cfg.dwval = 0x80041400;
	delay_us(10);
	...
	/* switch gtbus src: gtbus clk = 240M,
	 * at this time, ahb0 src is gtbus. */
	ccm_reg->ccm_reg->Gtclk_Cfg.dwval =
...
__s32 mem_clk_set_misc(struct clk_misc_t *clk_misc)
{
	...
	if (get_cur_cluster_id()) {
		/* atb=2; axi div = 3; */
		*(volatile __u32 *)&CmuReg->Axi1_Cfg = 0x102;
	} else {
		/* atb=2; axi div = 3; */
		*(volatile __u32 *)&CmuReg->Axi0_Cfg = 0x102;
	}
	asm volatile ("dsb");
	asm volatile ("isb");
	...
	if (get_cur_cluster_id()) {
		/* atb=4; axi div = 4; */
		*(volatile __u32 *)&CmuReg->Axi1_Cfg = 0x203;
	} else {
		/* atb=4; axi div = 4; */
		*(volatile __u32 *)&CmuReg->Axi0_Cfg = 0x203;
	}
	asm volatile ("dsb");
	asm volatile ("isb");

...
/*__save_processor_state: store the co-processor
 * state into to location point by ctxt
...
/*__restore_processor_state: restore the co-processor
 * state according the info point by ctxt
...
void __restore_processor_state(struct saved_context *ctxt)
{
	 ...
	 * will effect visible addr space, cache, instruction prediction */

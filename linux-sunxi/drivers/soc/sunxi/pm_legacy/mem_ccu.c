/*
 * drivers/soc/sunxi/pm_legacy/mem_ccu.c
 *
...
__s32 mem_ccu_save(struct ccm_state *ccm_reg)
{
	...
	/* 0x23c,  pll gpu   bias reg */
	ccm_reg->ccm_reg_backup.PllGpuBias = ccm_reg->ccm_reg->PllGpuBias;
	/* 0x240,  pll mipi  bias reg */
	ccm_reg->ccm_reg_backup.PllMipiBias = ccm_reg->ccm_reg->PllMipiBias;
	/* 0x244,  pll hsic  bias reg */
	ccm_reg->ccm_reg_backup.PllHsicBias = ccm_reg->ccm_reg->PllHsicBias;
	/* 0x248,  pll de    bias reg */
...
__s32 mem_ccu_restore(struct ccm_state *ccm_reg)
{
	...
	/* PllVedioBias;          0x228,  pll vedio bias reg */
	/* PllVeBias;              0x22c,  pll ve    bias reg */
	/* PllDram0Bias;          x230,  pll dram0 bias reg */
	/* PllPeriphBias;         0x234,  pll periph bias reg */
	/* reserved202;         /0x238,  reserved */
	/* 0x23c,  pll gpu   bias reg */
	ccm_reg->ccm_reg->PllGpuBias = ccm_reg->ccm_reg_backup.PllGpuBias
	/* 0x240,  pll mipi  bias reg */
	ccm_reg->ccm_reg->PllMipiBias = ccm_reg->ccm_reg_backup.PllMipiBias;
	/* 0x244,  pll hsic  bias reg */
...
__s32 mem_ccu_save(struct ccm_state *ccm_reg)
{
	...
	/*   ccm_reg->ccm_reg_backup.PllDdrCfg
	 *   = ccm_reg->ccm_reg->PllDdrCfg; */
	/*   ccm_reg->ccm_reg_backup.MbusResetReg
	 *   = ccm_reg->ccm_reg->MbusResetReg; */
	/*   ccm_reg->ccm_reg_backup.DramCf
	 *   = ccm_reg->ccm_reg->DramCfg; */
	/*   ccm_reg->ccm_reg_backup.DramGate
	 *   = ccm_reg->ccm_reg->DramGate; */
...
__s32 mem_ccu_save(struct ccm_state *ccm_reg)
{
	...
	/*   ccm_reg->ccm_reg_backup.MbusResetReg
	 *   = ccm_reg->ccm_reg->MbusResetReg; */
	/*   ccm_reg->ccm_reg_backup.DramCfg
	 *   = ccm_reg->ccm_reg->DramCfg; */
	/*   ccm_reg->ccm_reg_backup.DramGate
	 *   = ccm_reg->ccm_reg->DramGate; */
...
__s32 mem_ccu_restore(struct ccm_state *ccm_reg)
{
	...
	/* ccm_reg->ccm_mod_reg->dram_cfg
	 * = ccm_reg->ccm_mod_reg_backup.dram_cfg            ; */
	ccm_reg->ccm_mod_reg->de_sclk_cfg =
	    ccm_reg->ccm_mod_reg_backup.de_sclk_cfg;
	ccm_reg->ccm_mod_reg->edp_sclk_cfg =
	    ccm_reg->ccm_mod_reg_backup.edp_sclk_cfg;

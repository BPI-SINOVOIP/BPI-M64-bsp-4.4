/*
 * drivers/soc/sunxi/pm_legacy/standby/dram/mctl_reg.h
 *
...
#define mctl_write_w(v, addr)	(*((unsigned long  *)(addr)) = (unsigned long)(v))
#define mctl_read_w(addr)		(*((unsigned long  *)(addr)))

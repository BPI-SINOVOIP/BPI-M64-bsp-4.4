/*
 * drivers/soc/sunxi/pm_legacy/standby/super/super_i.h
 *
...
typedef struct _Resume_file_head {
	...
	/*  generated by PC */
	__u32 length;
	/*  the size of resume_file_head_t */
	__u32 pub_head_size;
	/*  the version of resume_file_head_t */
	__u8 pub_head_vsn[4];
	/*  the version of resume0_file_head_t or resume1_file_head_t */

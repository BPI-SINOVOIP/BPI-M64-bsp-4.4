/*
 * drivers/soc/sunxi/pm_legacy/standby/super/super_cpus.h
 *
...
#define ALL_CPUX_INVALIDATION_DONE	\
	(CPUX_INVALIDATION_DONE_FLAG ==	\
	readl(CPUX_INVALIDATION_DONE_FLAG_REG(CPUCFG_CPU1)) &&	\
	CPUX_INVALIDATION_DONE_FLAG ==	\
	readl(CPUX_INVALIDATION_DONE_FLAG_REG(CPUCFG_CPU2)) &&	\
	CPUX_INVALIDATION_DONE_FLAG ==	\
	readl(CPUX_INVALIDATION_DONE_FLAG_REG(CPUCFG_CPU3)))
#define ALL_CPUX_IS_WFI_MODE		\
	(IS_WFI_MODE(1) && IS_WFI_MODE(2) && IS_WFI_MODE(3))
...
#define CPUX_INVALIDATION_DONE_FLAG_REG(n)	\
	(STANDBY_STATUS_REG_PA + 0x04 + (n)*0x4)
#define CPUX_INVALIDATION_COMPLETION_FLAG_REG	\
	(CPUX_INVALIDATION_DONE_FLAG_REG(CPUCFG_CPU_NUMBER))

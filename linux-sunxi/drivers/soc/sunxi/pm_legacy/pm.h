...
struct gic_distributor_state {
	/* distributor */
	/* offset 0x00, distributor Contrl reg */
	volatile __u32 GICD_CTLR;
	/* offset 0x80, Interrupt Grp Reg ? */
	volatile __u32 GICD_IGROUPRn;
	/* offset 0x100-0x17c, Interrupt Set-Enable Reg */
	volatile __u32 GICD_ISENABLERn[0x180 / 4];
	/* offset 0x180-0x1fc, Iterrupt Clear-Enable Reg */
	volatile __u32 GICD_ICENABLERn[0x180 / 4];
	/* offset 0x200-0x27c, Iterrupt Set-Pending Reg */
	volatile __u32 GICD_ISPENDRn[0x180 / 4];
	/* offset 0x280-0x2fc, Iterrupt Clear-Pending Reg */
	volatile __u32 GICD_ICPENDRn[0x180 / 4];
	/* offset 0x300-0x37c, GICv2 Iterrupt Set-Active Reg */
	volatile __u32 GICD_ISACTIVERn[0x180 / 4];
	/* offset 0x380-0x3fc, Iterrupt Clear-Active Reg */
	volatile __u32 GICD_ICACTIVERn[0x180 / 4];
	/* offset 0x400-0x7F8, Iterrupt Priority Reg */
	volatile __u32 GICD_IPRIORITYRn[0x180 / 4];
	/* offset 0x820-0xbf8, Iterrupt Processor Targets Reg */
	volatile __u32 GICD_ITARGETSRn[(0x400 - 0x20) / 4];
	/* offset 0xc00-0xcfc, Iterrupt Config Reg */
	volatile __u32 GICD_ICFGRn[0x100 / 4];
	/* offset 0xE00-0xEfc, non-secure Access Ctrl Reg ? */
	volatile __u32 GICD_NSACRn[0x100 / 4];
	/* offset 0xf10-0xf1c, SGI Clear-Pending Reg */
	volatile __u32 GICD_CPENDSGIRn[0x10 / 4];
	/* offset 0xf20-0xf2c, SGI Set-Pending Reg */
	volatile __u32 GICD_SPENDSGIRn[0x10 / 4];
};

struct gic_cpu_interface_state {
	/* cpu interface reg */
	/* offset 0x00-0x08, cpu interface Ctrl Reg +
	 * Interrupt Priority Mask Reg+Binary Point Reg */
	volatile __u32 GICC_CTLR_PMR_BPR[0xc / 4];
	/* offset 0x1c, Aliased Binary Point Reg */
	volatile __u32 GICC_ABPR;
	/* offset 0xd0-0xdc, Active Priorities Reg */
	volatile __u32 GICC_APRn[0x10 / 4];
	/* offset 0xe0-0xec, Non-secure Active Priorities Reg */
	volatile __u32 GICC_NSAPRn[0x10 / 4];
};
...
struct gic_distributor_disc {
	...
	volatile __u32 GICD_CTLR;
	/* 0ffset 0x04-0x7c */
	volatile __u32 reserved0[0x7c / 4];
	/* offset 0x80, Interrupt Grp Reg ? */
	volatile __u32 GICD_IGROUPRn;
	/* 0ffset 0x84-0xfc */
	volatile __u32 reserved1[0x7c / 4];
	/* offset 0x100-0x17c, Interrupt Set-Enable Reg */
	volatile __u32 GICD_ISENABLERn[0x180 / 4];
	/* offset 0x180-0x1fc, Iterrupt Clear-Enable Reg */
	volatile __u32 GICD_ICENABLERn[0x180 / 4];
...
struct gic_cpu_interface_disc {
	 ...
	 * Interrupt Priority Mask Reg + Binary Point Reg */
	volatile __u32 GICC_CTLR_PMR_BPR[0xc / 4];
	/* 0ffset 0xC-0x18, readonly or writeonly */
	volatile __u32 reserved7[0x10 / 4];
	/* offset 0x1c, Aliased Binary Point Reg */
	volatile __u32 GICC_ABPR;
	/* 0ffset 0x20-0xcf, readonly or writeonly */
	volatile __u32 reserved8[0xb0 / 4];
	/* offset 0xd0-0xdc, Active Priorities Reg */
	volatile __u32 GICC_APRn[0x10 / 4];
	/* offset 0xe0-0xec, Non-secure Active Priorities Reg */
	volatile __u32 GICC_NSAPRn[0x10 / 4];
	/* 0ffset 0xf0-0xfc, readonly or writeonly */
	volatile __u32 reserved9[0x10 / 4];
	/* 0ffset 0xf0-0xfc, readonly or writeonly */
	volatile __u32 reserved10[0xf00 / 4];
	/* 0ffset 0x1000, readonly or writeonly */
	volatile __u32 reserved11;

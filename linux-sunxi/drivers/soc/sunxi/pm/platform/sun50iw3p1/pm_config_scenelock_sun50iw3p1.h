...
#ifndef _SCENELOCK_EXSTANDBY_CFG_SUN50IW3P1_H
#define _SCENELOCK_EXSTANDBY_CFG_SUN50IW3P1_H
...
struct scene_extended_standby_t extended_standby[] = {
	...
	},
	{
		...
		/* for pf port: set the io to disable state.; */
		.soc_pwr_dep.soc_io_state.io_state[0]     = {0xd300b0b4, 0x00f0f0ff, 0x00707077},
		.soc_pwr_dep.soc_io_state.io_state[1]     = {0xd300b0b4, 0x000f0f00, 0x00070700},
	},
	{
...

	{
		...
		.soc_pwr_dep.soc_pwr_dm_state.state	   = BITMAP(VCC_DRAM_BIT) | BITMAP(VDD_CPUS_BIT) |\
							     BITMAP(VCC_PL_BIT) | \
							     BITMAP(VCC_IO_BIT), 0x0644, /* -vcc_io; -dram, ldoin/ adc/ cpvdd */
		/* mean care about cpua, dram, sys, cpus, dram_pll, vdd_adc, vcc_pl, vcc_io, vcc_cpvdd, vcc_ldoin, vcc_pll */
		.soc_pwr_dep.soc_pwr_dm_state.volt[0]      = 0x0,	/* mean: donot need care about the voltage. */
		.soc_pwr_dep.cpux_clk_state.osc_en         = 0x0,	/* mean all osc is off. */
...
#endif /* _SCENELOCK_EXSTANDBY_CFG_SUN50IW3P1_H */

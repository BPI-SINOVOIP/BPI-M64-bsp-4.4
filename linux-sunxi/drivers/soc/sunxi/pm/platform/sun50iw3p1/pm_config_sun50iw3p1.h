/*
 * drivers/soc/sunxi/pm/platform/sun8iw12p1/pm_config_sun8iw12p1.h
...
#ifndef _PM_CONFIG_SUN50IW3P1_H
#define _PM_CONFIG_SUN50IW3P1_H
...
#define SUNXI_RTC_PBASE				(0x07000000)
...
#define SRAM_FUNC_START				(0xf0020000)
#define SRAM_FUNC_START_PA			(0x00020000)
/*for mem mapping*/
 ...
 */
#define SP_IN_SRAM				(0xf002bff0) /*end of 48k */
#define SP_IN_SRAM_PA				(0x0002bff0) /*end of 48k */
/*15k */
#define SP_IN_SRAM_START			(SRAM_FUNC_START_PA | 0x3c00)

#endif /*_PM_CONFIG_SUN8IW12P1_H*/

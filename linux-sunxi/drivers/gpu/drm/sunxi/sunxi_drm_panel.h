...
struct panel_ops {
	...
	enum drm_mode_status (*check_valid_mode)(
		struct sunxi_panel *panel, struct drm_display_mode *mode);
	enum drm_mode_status (*change_mode_to_timming)(
		void *timing, struct drm_display_mode *mode);
...
struct sunxi_panel *sunxi_panel_creat(enum disp_output_type type,
	int pan_id);

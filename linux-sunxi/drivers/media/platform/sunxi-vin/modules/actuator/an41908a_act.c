...
static int act_spi_read(struct v4l2_subdev *sd, unsigned char reg, unsigned short *val)
{
...
static int act_spi_write(struct v4l2_subdev *sd, unsigned char reg, unsigned short val)
{
	struct spi_device *spi = v4l2_get_subdevdata(sd);
	loff_t to = reg;

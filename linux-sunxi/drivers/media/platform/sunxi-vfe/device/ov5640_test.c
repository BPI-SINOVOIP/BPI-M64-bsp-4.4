...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) printk(KERN_DEBUG"[OV5640]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) printk(KERN_ERR"[OV5640]"x, ##arg)
#define vfe_dev_print(x, arg...) printk(KERN_NOTICE"[OV5640]"x, ##arg)

#define CAP_BDG 0
#if (CAP_BDG == 1)
#define vfe_dev_cap_dbg(x, arg...) printk(KERN_DEBUG"[OV5640_CAP_DBG]"x, ##arg)
#else
...
0x02, 0x0f, 0xd6, 0x02, 0x0a, 0x39, 0xc2, 0x01, 0x22, 0x22, 0x00, 0x02,\
										0x0f, 0xb2, 0xe5, 0x1f, /* 0x8000, */
  0x70, 0x72, 0xf5, 0x1e, 0xd2, 0x35, 0xff, 0xef, 0x25, 0xe0, 0x24, 0x4e,\
										0xf8, 0xe4, 0xf6, 0x08, /* 0x8010, */
  0xf6, 0x0f, 0xbf, 0x34, 0xf2, 0x90, 0x0e, 0x93, 0xe4, 0x93, 0xff, 0xe5,\
										0x4b, 0xc3, 0x9f, 0x50, /* 0x8020, */

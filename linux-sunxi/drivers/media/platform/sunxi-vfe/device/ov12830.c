...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV12830]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV12830]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV12830]"x, ##arg)
...
/* initialize to 2112x1500 30fps with binning */
	...
	{0x37df, 0x00},
	/* blc */
	/* window select as blc does, use reg 0x4006 as K for DC BLC */
	{0x4000, 0x18},
	{0x4001, 0x06}, /* blc start line */
	/*
	*[7]:redo after format change;
	*[6]: blc auto,
	*do 5 frames blc after reset
	*/
	{0x4002, 0x45},
	{0x4004, 0x02}, /* number of black lines */
	/*
	*no black line output,
	*apply one channel offset (0x400c, 0x400d) to all channes
	*/
	{0x4005, 0x19},
	/*
	*enable media filter,
	*window do not contain first 1/16 and last 1/16
	*/
	{0x4007, 0x90},
	{0x4008, 0x20},
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	/* vfe_dev_print("5647 sensor_set_gain = %d, Done!\n", gain_val); */
	info->gain = gain_val;

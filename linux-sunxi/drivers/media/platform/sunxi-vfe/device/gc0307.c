...
#define DEV_DBG_EN   0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][GC0307]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][GC0307]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][GC0307]"x, ##arg)
...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
	...
	case CSI_SUBDEV_STBY_ON:
		...
		ret = sensor_write_array(sd, sensor_oe_disable,
				ARRAY_SIZE(sensor_oe_disable));
		if (ret < 0)

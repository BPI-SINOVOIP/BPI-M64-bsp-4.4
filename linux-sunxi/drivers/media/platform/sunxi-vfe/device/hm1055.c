...
#define DEV_DBG_EN    0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][HM1055]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][HM1055]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][HM1055]"x, ##arg)
...
static int sensor_detect(struct v4l2_subdev *sd)
{
	...
	vfe_dev_print("############ HM1055 SENSOR_ID=0x%x\n", SENSOR_ID);
...
static int sensor_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	*/
	...
	/*
	*case V4L2_CID_RESOLUTION:  //use in linux-3.10

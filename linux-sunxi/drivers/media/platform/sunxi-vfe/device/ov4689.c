...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[ov4689]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[ov4689]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[ov4689]"x, ##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	*/
	...
	/*
	*MIPI always high speed off, Clock lane gate off,
	...
	*/
	...
	/*
	*enable emb clock, enable strobe clock,
	*enable timing control clock, mipi-phy manual reset,

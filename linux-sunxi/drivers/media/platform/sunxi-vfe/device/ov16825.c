...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV16825]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV16825]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV16825]"x, ##arg)
...
/* 0x5040, 0xa4, //test mode */
	...
	{0x5988, 0x00},
	/*
	*Because current regsiter number in group hold is more than 85(default),
	*change group1 and
	*/
				...
				struct sensor_exp_gain *exp_gain)
{
	...
	/*
	*vfe_dev_print("16825 sensor_set_gain = %d, %d, %d, Done!\n",
	*			gain_val, gainhigh, gainlow);
	*/
	/*
	*vfe_dev_print("16825 sensor_set_exp = %d, %d, %d, Done!\n",
...
static int sensor_s_exp(struct v4l2_subdev *sd, unsigned int exp_val)
{
	...
	sensor_write(sd, 0x3501, expmid);
	sensor_write(sd, 0x3500, exphigh);
	vfe_dev_print("16825 sensor_set_exp = %d, Done!\n", exp_val);
				...
				struct v4l2_subdev_format *fmat)
{
	...
	*/
	...
	vfe_dev_print("ov16825 set info->exp = 0........................\n");
	info->exp = 0;
	info->gain = 0;

...
#define DEV_DBG_EN    0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][GC0309]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][GC0309]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][GC0309]"x, ##arg)

...
#define DEV_DBG_EN    1
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][GC2155]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif

#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][GC2155]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][GC2155]"x, ##arg)
...
static int sensor_remove(struct i2c_client *client)
{
	...
	pr_info("sensor_remove gc2155 sd = %p!\n", sd);
	kfree(to_state(sd));
	return 0;
}

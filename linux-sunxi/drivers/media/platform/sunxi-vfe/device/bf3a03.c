...
#define DEV_DBG_EN   1
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][BF3A03]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][BF3A03]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][BF3A03]"x, ##arg)
...
static int sensor_s_contrast(struct v4l2_subdev *sd, int value)
{
	...
	LOG_ERR_RET(sensor_write_array(sd,
		sensor_contrast[value+4].regs, sensor_contrast[value+4].size));
...
static int sensor_s_exp_bias(struct v4l2_subdev *sd, int value)
{
	...
	LOG_ERR_RET(sensor_write_array(sd,
		sensor_ev[value+4].regs, sensor_ev[value+4].size));
				...
				enum v4l2_auto_n_preset_white_balance value)
{
	...
	if (info->wb == value)
		return 0;
	LOG_ERR_RET(sensor_write_array(sd,
		sensor_wb[value].regs, sensor_wb[value].size));
				...
				enum v4l2_colorfx value)
{
	...
	LOG_ERR_RET(sensor_write_array(sd,
		sensor_colorfx[value].regs, sensor_colorfx[value].size));

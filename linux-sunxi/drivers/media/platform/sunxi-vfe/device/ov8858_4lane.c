...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV8858_4lane]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV8858_4lane]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV8858_4lane]"x, ##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	/* ; gain delay 1 frame, exposure delay 1 frame, sensor gain */
	{0x3503, 0x70},
	...
	{0x3846, 0x48},
	/* OTP power up load data enable,OTP powerr up load setting disable */
	{0x3d85, 0x14},
	{0x3f08, 0x08},
	{0x3f0a, 0x80},
	/*
	*out_range_trig,
	*format_chg_trig, gain_trig,
	*exp_chg_trig,
	...
	*/
	...
	/* interpolation x disable,interpolation y disable,Anchor one disable */
	{0x401f, 0x00},
	{0x4034, 0x3f},
	...
	/*
	*slave AWB gain enable,
	*slave AWB statistics enable,
	*master AWB gain enable,
	*master AWB statistics enable,
	*BPC on, WPC on
	*/
	{0x5000, 0x7f},
	{0x5001, 0x01}, /* ; BLC on */
	/*
	*H scale off,
	*WBMATCH select slave sensor's gain,
	*WBMATCH off,
	*OTP_DPC off,
	*/
	{0x5002, 0x08},
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	/* vfe_dev_print("8858 sensor_set_gain = %d, Done!\n", gain_val); */
	info->gain = gain_val;

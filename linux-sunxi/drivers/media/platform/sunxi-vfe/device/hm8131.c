...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[HM8131]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[HM8131]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[HM8131]"x, ##arg)
...
static struct regval_list sensor_quxga_regs[] = {
	...
	{0x4B07, 0xF0},
	{0x4131, 0x01},
/* [5] mask out bad frame due to mode (flip/mirror) change */
	{0x4274, 0x33},
	...
	/* clock always on(9E) clock always on while sending packet(BE) */
	{0x4B20, 0x9E},
	{0x4B0E, 0x03},
	{0x4B42, 0x05},
...
static struct regval_list sensor_sxga_regs[] = {
	...
	/* lock always on(9E) / clock always on while sending packet(BE) */
	{0x4B20, 0x9E},
	{0x4B0E, 0x01},
	{0x4B42, 0x02},
				...
				struct sensor_exp_gain *exp_gain)
{
	...
	unsigned char gainlow = 0; /* ainhigh=0; */
	struct sensor_info *info = to_state(sd);

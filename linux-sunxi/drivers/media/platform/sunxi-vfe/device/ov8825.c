...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV8825]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV8825]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV8825]"x, ##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	/* clear PHY HS TX power down and PHY LP RX power down */
	{0x3018, 0x00},
	...
	/* VCM clock divider, VCM clock = 24000000/0x4b0 = 20000 */
	{0x361a, 0xB0},
	...
	/*
	*no black line output,
	*apply one channel offset (0x400c, 0x400d) to all manual BLC
	*/
	{0x4005, 0x18},
	/* channels */
	{0x4300, 0xff}, /* max */
	...
	/*
	*|(CLOCK_INCONT<<5),
	*bit5 0:clock free running 1:gating when blanking
	*/
	{0x4800, 0x04},
	...
	{0x5849, 0xd5},
	/* Exposure */
	/* Gain has no delay, VTS manual, AGC manual, AEC manual */
	{0x3503, 0x17},
				...
				struct sensor_exp_gain *exp_gain)
{
	...
	/*
	*ov8825 doesn't support fraction exposure time
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	vfe_dev_print("8825 sensor_set_gain = %d, Done!\n", gain_val);
	info->gain = gain_val;

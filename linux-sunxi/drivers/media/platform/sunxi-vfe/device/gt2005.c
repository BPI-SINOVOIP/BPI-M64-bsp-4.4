...
#define DEV_DBG_EN   0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][GT2005]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif

#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][GT2005]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][GT2005]"x, ##arg)
...
static int sensor_s_brightness(struct v4l2_subdev *sd, int value)
{
	...
	LOG_ERR_RET(sensor_write_array(sd,
				sensor_brightness[value+4].regs,
...
static int sensor_s_saturation(struct v4l2_subdev *sd, int value)
{
	...
	LOG_ERR_RET(sensor_write_array(sd,
				sensor_saturation[value+4].regs,

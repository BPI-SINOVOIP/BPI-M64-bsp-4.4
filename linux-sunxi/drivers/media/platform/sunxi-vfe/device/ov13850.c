...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[ov13850]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[ov13850]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[ov13850]"x, ##arg)
...
static struct regval_list sensor_13mega_regs[] = {
 /* ;XVCLK=24Mhz, SCLK=4x120Mhz, MIPI 640Mbps, DACCLK=240Mhz */
	...
	/*
	*OTP power up load data enable,
	*power load setting enable,
	*software load setting
	*/
	{0x3d85, 0x17},
				...
				struct sensor_exp_gain *exp_gain)
{
	...
	/*
	*vfe_dev_print("exp_val = %d,gain_val = %d %x%x\n",
...
/* vfe_dev_print("ov13850 sensor_set_exp = %d\n", tmp); */
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	/*
	*vfe_dev_print("ov13850 sensor_set_gain = %d,
	*			Done!\n", gain_val);
	*/
	info->gain = gain_val;
...
/* info->height = 3456; */
	...
	ret = sensor_write_array(sd, sensor_default_regs,
				0 /* ARRAY_SIZE(sensor_default_regs)*/);
	if (ret < 0) {

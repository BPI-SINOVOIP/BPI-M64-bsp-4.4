...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV2640]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV2640]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV2640]"x, ##arg)
				...
				enum v4l2_auto_n_preset_white_balance value)
{
	...
	if (value == V4L2_WHITE_BALANCE_AUTO)
		...
		case V4L2_WHITE_BALANCE_CLOUDY:
			ret = sensor_write_array(sd, sensor_wb_cloud_regs,
				ARRAY_SIZE(sensor_wb_cloud_regs));
			break;
		case V4L2_WHITE_BALANCE_DAYLIGHT:
			ret = sensor_write_array(sd, sensor_wb_daylight_regs,
				ARRAY_SIZE(sensor_wb_daylight_regs));
			break;
		case V4L2_WHITE_BALANCE_INCANDESCENT:
			ret = sensor_write_array(sd,
				sensor_wb_incandescence_regs,
				ARRAY_SIZE(sensor_wb_incandescence_regs));
			break;
		case V4L2_WHITE_BALANCE_FLUORESCENT:
			ret = sensor_write_array(sd, sensor_wb_fluorescent_regs,
				ARRAY_SIZE(sensor_wb_fluorescent_regs));
			break;
		case V4L2_WHITE_BALANCE_FLUORESCENT_H:
			ret = sensor_write_array(sd, sensor_wb_tungsten_regs,
				ARRAY_SIZE(sensor_wb_tungsten_regs));
			break;
		default:
			return -EINVAL;
		}
...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
	...
	case CSI_SUBDEV_STBY_ON:
		...
		ret = sensor_write_array(sd, sensor_sw_stby_on_regs,
	...
	case CSI_SUBDEV_STBY_OFF:
		...
		ret = sensor_write_array(sd, sensor_sw_stby_off_regs,

...
#define DEV_DBG_EN   0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][NT99141]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][NT99141]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][NT99141]"x, ##arg)
				...
				struct v4l2_subdev_format *fmat)
{
	...
	ret = 0;
	if (wsize->regs) {
		ret = sensor_write_nt99141_array(sd, wsize->regs,
				wsize->regs_size);
		if (ret < 0)
			return ret;
	}

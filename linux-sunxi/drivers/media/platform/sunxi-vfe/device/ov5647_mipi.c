...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV5647_mipi]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV5647_mipi]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV5647_mipi]"x, ##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	/* ; Vsync, Href, PCLK, Frex, Strobe, SDA, GPIO1, GPIO0 output */
	{0x3002, 0xff},
	{0x301d, 0xf0},
	...
	/* ; Vsync, Href, PCLK, Frex, Strobe, SDA, GPIO1, GPIO0 input */
	{0x3002, 0x00},
...
/* return 0; */
	...
	sensor_write(sd, 0x3208, 0x10); /* end group write */
	sensor_write(sd, 0x3208, 0xa0); /* init group write */
	/* vfe_dev_print("5647 sensor_set_exp = %d, Done!\n", exp_val); */

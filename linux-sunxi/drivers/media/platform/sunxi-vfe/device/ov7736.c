...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV7736]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV7736]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV7736]"x, ##arg)

#define CAP_BDG 0
#if (CAP_BDG == 1)
#define vfe_dev_cap_dbg(x, arg...) pr_debug("[OV7736_CAP_DBG]"x, ##arg)
#else

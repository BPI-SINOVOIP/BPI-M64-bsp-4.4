...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV5650]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV5650]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV5650]"x, ##arg)
...
static struct regval_list sensor_qsxga_regs[] = {
	...
	/* [7:4]SOF to HREF delay(count in lines) [1:0]vts ctrl */
	{0x3819, 0x80},
	...
	{0x3a01, 0x00}, /* min exp?? */
	/* [6:0] LOL/band_en/band_low_limit/m.n_en/debug/freeze */
	{0x3a00, 0x38},
...
/* SXGA: 1280*960@30fps //64MHz pclk */
...
/* 1080: 1920*1080@30fps //96MHz pclk */
...
/* vfe_dev_dbg("sensor_set_exposure = %d\n", exp_val>>4); */
	...
	/* vfe_dev_print("5650 sensor_set_exp = %d, Done!\n", exp_val); */
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	/* vfe_dev_print("5650 sensor_set_gain = %d, Done!\n", gain_val); */
	info->gain = gain_val;

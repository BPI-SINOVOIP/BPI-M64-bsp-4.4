...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV5648]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV5648]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV5648]"x, ##arg)
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	vfe_dev_print("5648 sensor_set_gain = %d, Done!\n", gain_val);
	info->gain = gain_val;

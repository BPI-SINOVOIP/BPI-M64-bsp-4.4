...
#define DEV_DBG_EN		0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][H42_AW6121]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][H42_AW6121]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][H42_AW6121]"x, ##arg)
...
*	.regs = (struct regval_list)reg_band_50hz_reg,
*	.size = ARRAY_SIZE(reg_band_50hz_reg),
*	},
*	{
*	//.regs = reg_band_60hz_reg,
*	.regs = (struct regval_list)reg_band_60hz_reg,
...
{
	struct sensor_info *info = to_state(sd);
	/*There is a  warning!but not know it was use or not */
	/*
	enum v4l2_power_line_frequency *band_filter =
		(enum v4l2_auto_n_preset_white_balance *)value;
	*/
	enum v4l2_power_line_frequency *band_filter = &value;
...
static int sensor_s_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *parms)
{
	...
	case 30:
		...
		break;
	case 25:
		pr_info("switch fps to 25.\n");
		break;
	case 20:
		pr_info("switch fps to 20.\n");
		break;
	case 15:
		pr_info("switch fps to 15.\n");
		break;
	default:
		pr_info("switch fps to nothing.\n");
		break;
	}
	return 0;
}
...
static int sensor_g_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	case V4L2_CID_POWER_LINE_FREQUENCY:
		pr_info("sensor_s_ctrl13g ctrl->id = %d\n", ctrl->id);

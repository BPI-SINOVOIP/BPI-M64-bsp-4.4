...
#define AIF2_CLK_CTRL		0x20
#define AIF2_ADCDAT_CTRL	0x21
#define AIF2_DACDAT_CTRL	0x22
#define AIF2_MXR_SRC		0x23
#define AIF2_VOL_CTRL1		0x24
#define AIF2_VOL_CTRL2		0x26
#define AIF2_MXR_GAIN		0x28
#define AIF2_RXD_CTRL		0x29

#define AIF3_CLK_CTRL		0x30
#define AIF3_ADCDAT_CTRL	0x31
#define AIF3_DACDAT_CTRL	0x32
#define AIF3_SGP_CTRL		0x33
#define AIF3_RXD_CTRL		0x39
...
/*#define AIF1_SLOT_SIZ		0*/
#define AIF1_LOOP_EN		0

/*AIF1_MXR_SRC: 0x13*/
/*AIF1 ADCDATA timeslot0 Left Channel mixer source select*/
...
/*AIF1 ADCDATA timeslot0 Right Channel mixer source select*/
...
/*AIF1 ADCDATA timeslot1 Left Channel mixer source select*/
#define AIF1_AD1L_AIF2_DACL_MXR		7
#define AIF1_AD1L_ADCL_MXR		6
#define AIF1_AD1L_MXR_SRC	6
/*AIF1 ADCDATA timeslot1 Right Channel mixer source select*/
...
/*AIF2_MXR_SRC; 0x23*/
/*AIF2 ADCDATA Left Channel mixer source select*/
...
/*AIF2 ADCDATA Right Channel mixer source select*/
...
#ifdef AC100_DEBG
#define AC100_DBG(format, args...) \
	printk(KERN_INFO"[AC100] "format, ##args)
#else
#define AC100_DBG(...)
#endif

...
/* start of I2S NUM
 * to use the correct I2S, some is for bt etc., the other is for HDMI
 * sun50iw1:3 I2S, one if for HDMI, the other two are for DAUDIO.
 * sun50iw3:3 I2S, none is for HDMI.
 */
#if defined(CONFIG_ARCH_SUN8IW7) || defined(CONFIG_ARCH_SUN50IW1)
#define SUNXI_DAUDIO_NUM_THREE
#else
#undef SUNXI_DAUDIO_NUM_THREE
#endif
/*end of I2S NUM*/

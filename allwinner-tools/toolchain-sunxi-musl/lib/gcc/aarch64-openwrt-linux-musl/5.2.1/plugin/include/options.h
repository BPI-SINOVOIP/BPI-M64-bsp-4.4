...
enum opt_code
{
  ...
  OPT_mabi_ = 1140,                          /* -mabi= */
  OPT_march_ = 1141,                         /* -march= */
  OPT_mbig_endian = 1142,                    /* -mbig-endian */
  OPT_mbionic = 1143,                        /* -mbionic */
  OPT_mcmodel_ = 1144,                       /* -mcmodel= */
  OPT_mcpu_ = 1145,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1146,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1147,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1148,             /* -mgeneral-regs-only */
  OPT_mglibc = 1149,                         /* -mglibc */
  OPT_mlittle_endian = 1150,                 /* -mlittle-endian */
  OPT_mmusl = 1151,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1152,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1153,                     /* -moverride= */
  OPT_mstrict_align = 1154,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1155,                  /* -mtls-dialect= */
  OPT_mtune_ = 1156,                         /* -mtune= */
  OPT_muclibc = 1157,                        /* -muclibc */
  OPT_n = 1158,                              /* -n */
  OPT_no_canonical_prefixes = 1159,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1160,              /* -no-integrated-cpp */
  OPT_nocpp = 1161,                          /* -nocpp */
  OPT_nodefaultlibs = 1162,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1163,                   /* -nostartfiles */
  OPT_nostdinc = 1164,                       /* -nostdinc */
  OPT_nostdinc__ = 1165,                     /* -nostdinc++ */
  OPT_nostdlib = 1166,                       /* -nostdlib */
  OPT_o = 1167,                              /* -o */
  OPT_p = 1168,                              /* -p */
  OPT_pass_exit_codes = 1169,                /* -pass-exit-codes */
  /* OPT_pedantic = 1170, */                 /* -pedantic */
  OPT_pedantic_errors = 1171,                /* -pedantic-errors */
  OPT_pg = 1172,                             /* -pg */
  OPT_pie = 1173,                            /* -pie */
  OPT_pipe = 1174,                           /* -pipe */
  OPT_posix = 1175,                          /* -posix */
  OPT_print_file_name_ = 1176,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1177,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1178,          /* -print-multi-directory */
  OPT_print_multi_lib = 1179,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1180,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1181,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1182,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1183,               /* -print-prog-name= */
  OPT_print_search_dirs = 1184,              /* -print-search-dirs */
  OPT_print_sysroot = 1185,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1186,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1187,                        /* -profile */
  OPT_pthread = 1188,                        /* -pthread */
  OPT_quiet = 1189,                          /* -quiet */
  OPT_r = 1190,                              /* -r */
  OPT_rdynamic = 1191,                       /* -rdynamic */
  ...
  OPT_static_liblsan = 1207,                 /* -static-liblsan */
  OPT_static_libmpx = 1208,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1209,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1210,               /* -static-libstdc++ */
  OPT_static_libtsan = 1211,                 /* -static-libtsan */
  OPT_static_libubsan = 1212,                /* -static-libubsan */
  /* OPT_std_c__03 = 1213, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1214, */                /* -std=c++0x */
  OPT_std_c__11 = 1215,                      /* -std=c++11 */
  OPT_std_c__14 = 1216,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1217, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1218, */                /* -std=c++1y */
  OPT_std_c__1z = 1219,                      /* -std=c++1z */
  ...
  /* OPT_std_gnu__17 = 1236, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1237, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1238,                    /* -std=gnu++1z */

...
static int mmc_init_default_timing_para(int sdc_no)
{
	...
	if (sdc_no == 0) {
		...
		mmchost->tm1
		    .def_odly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM1_OUT_PH180;
		mmchost->tm1
		    .def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM1_IN_PH180;
		mmchost->tm1.def_odly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_OUT_PH180;
		mmchost->tm1.def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_IN_PH180;

		mmchost->tm1
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_OUT_PH180;
		mmchost->tm1
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_IN_PH90;
		mmchost->tm1
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_OUT_PH180;
		mmchost->tm1
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_IN_PH90;

		mmchost->tm1
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_OUT_PH90;
		mmchost->tm1
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_IN_PH180;
		mmchost->tm1
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_OUT_PH90;
		mmchost->tm1
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_IN_PH180;

		mmchost->tm1
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_OUT_PH180;
		mmchost->tm1
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_IN_PH90;
		mmchost->tm1
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_OUT_PH180;
		mmchost->tm1
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_IN_PH90;
		...
		mmchost->tm3
		    ...
		    TM3_OUT_PH180;
		mmchost->tm3
		    .def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_400K] = 0x0;
		mmchost->tm3.def_odly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM3_OUT_PH180;
		mmchost->tm3.def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    0x0;
		...
		mmchost->tm3
		    ...
		    TM3_OUT_PH180;
		mmchost->tm3
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_25M] = 0x0;
		mmchost->tm3
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM3_OUT_PH180;
		mmchost->tm3
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] = 0x0;

		mmchost->tm3
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM1_OUT_PH90;
		mmchost->tm3
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] = 0x0;
		mmchost->tm3
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM1_OUT_PH90;
		mmchost->tm3
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] = 0x0;

		mmchost->tm3
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM3_OUT_PH180;
		mmchost->tm3
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_25M] = 0x0;
		mmchost->tm3
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM3_OUT_PH180;
		mmchost->tm3
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_50M] = 0x0;
	} else if (sdc_no == 2) {
		/* timing mode 4 */
		...
		mmchost->tm4
		    .def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_400K] = 0x0;
		mmchost->tm4.def_odly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM4_OUT_PH180;
		mmchost->tm4.def_sdly[DS26_SDR12 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    0x0;

		mmchost->tm4
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_400K] = 0;
		mmchost->tm4
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_25M] = 0;
		mmchost->tm4
		    .def_odly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSSDR52_SDR25 * MAX_CLK_FREQ_NUM + CLK_50M] = 0;

		mmchost->tm4
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    0xe;
		mmchost->tm4
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_25M] = 0xe;
		mmchost->tm4
		    .def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] = 0xe;

		mmchost->tm4
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM4_OUT_PH180;
		mmchost->tm4
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_400K] = 0x0;
		mmchost->tm4
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM4_OUT_PH90;
		mmchost->tm4
		...
		mmchost->tm4
		    ...
		    TM4_OUT_PH90;
		mmchost->tm4
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_50M] = 0x11;
		mmchost->tm4
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_100M] =
		    TM4_OUT_PH90;
		mmchost->tm4
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_100M] =
		    0x12;
		mmchost->tm4
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_150M] =
		    TM4_OUT_PH90;
		mmchost->tm4
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_150M] =
		    0x13;
		mmchost->tm4
		    .def_odly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_200M] =
		    TM4_OUT_PH90;
		mmchost->tm4
		    .def_sdly[HS200_SDR104 * MAX_CLK_FREQ_NUM + CLK_200M] = 0x6;

		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    TM4_OUT_PH180;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_400K] =
		    0x0;
		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_25M] =
		    TM4_OUT_PH90;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_25M] = 0x0;
		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    TM4_OUT_PH90;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_50M] =
		    0x11;
		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_100M] =
		    TM4_OUT_PH90;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_100M] =
		    0x12;
		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_150M] =
		    TM4_OUT_PH90;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_150M] =
		    0x13;
		mmchost->tm4.def_odly[HS400 * MAX_CLK_FREQ_NUM + CLK_200M] =
		    TM4_OUT_PH90;
		mmchost->tm4.def_sdly[HS400 * MAX_CLK_FREQ_NUM + CLK_200M] =
		    0x6;
...
static int mmc_get_sdly_auto_sample(int sdc_no)
{
	...
	struct boot_sdmmc_private_info_t *priv_info =
	    (struct boot_sdmmc_private_info_t *)(uboot_spare_head.boot_data
						     .sdcard_spare_data);
	...
	for (spd_md = 0; spd_md < MAX_SPD_MD_NUM; spd_md++) {
		if (spd_md == HS400) {
			...
			for (f = 0; f < 4; f++) {
				mmchost->tm4
				    .sdly[spd_md * MAX_CLK_FREQ_NUM + f] =
				    (val >> (f * 8)) & 0xFF;
				/*MMCINFO("hs400 sdly-0 0x%x\n",
				 * mmchost->tm4.sdly[spd_md*MAX_CLK_FREQ_NUM +
				 * f]);*/
			}
	...
	if (sdc_no == 2) {
		if (mmchost->timing_mode == SUNXI_MMC_TIMING_MODE_4) {
			...
			for (imd = 0; imd < MAX_SPD_MD_NUM; imd++) {
				for (ifreq = 0; ifreq < MAX_CLK_FREQ_NUM;
				     ifreq++) {
					/* MMCINFO("%d %d\n",
					 * cfg->platform_caps.odly_spd_freq[imd*MAX_CLK_FREQ_NUM
					 * + ifreq],
					 * cfg->platform_caps.sdly_spd_freq[imd*MAX_CLK_FREQ_NUM
					 * + ifreq]); */
					p->odly[imd * MAX_CLK_FREQ_NUM +
						ifreq] =
					    cfg->platform_caps.odly_spd_freq
						[imd * MAX_CLK_FREQ_NUM +
						 ifreq];
					if (imd == HS400) {
						p->dsdly[ifreq] =
						    cfg->platform_caps.sdly_spd_freq
							[imd *
							     MAX_CLK_FREQ_NUM +
							 ifreq];
					} else {
						p->sdly[imd * MAX_CLK_FREQ_NUM +
							ifreq] =
						    cfg->platform_caps.sdly_spd_freq
							[imd *
							     MAX_CLK_FREQ_NUM +
...
static int mmc_update_timing_para(int sdc_no)
{
	...
	if (p->sample_mode == AUTO_SAMPLE_MODE) {
		...
		if (sdc_no == 0) {
			mmchost->tm1
			    .odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
			    mmchost->tm1
				.def_odly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM +
					  CLK_50M];
			mmchost->tm1
			    .sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM + CLK_50M] =
			    mmchost->tm1
				.def_sdly[HSDDR52_DDR50 * MAX_CLK_FREQ_NUM +
					  CLK_50M];
		} else {
...
static void mmc_get_para_from_fex(int sdc_no)
{
	...
	if (sdc_no == 0) {
		nodeoffset =
		    fdt_path_offset(working_fdt, FDT_PATH_CARD0_BOOT_PARA);
		if (nodeoffset < 0) {
		...
		/* ret = script_parser_fetch("card0_boot_para", "sdc_wipe",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_wipe",
				      (uint32_t *)(&rval));
		if (ret < 0)
			...
			if (rval & DRV_PARA_DISABLE_SECURE_WIPE) {
				MMCINFO(
				    "disable driver secure wipe operation.\n");
				cfg->platform_caps.drv_wipe_feature |=
				    DRV_PARA_DISABLE_SECURE_WIPE;
			}
			if (rval & DRV_PARA_DISABLE_EMMC_SANITIZE) {
				MMCINFO("disable emmc sanitize feature.\n");
				cfg->platform_caps.drv_wipe_feature |=
				    DRV_PARA_DISABLE_EMMC_SANITIZE;
			}
			if (rval & DRV_PARA_DISABLE_EMMC_SECURE_PURGE) {
				MMCINFO("disable emmc secure purge feature.\n");
				cfg->platform_caps.drv_wipe_feature |=
				    DRV_PARA_DISABLE_EMMC_SECURE_PURGE;
			}
			if (rval & DRV_PARA_DISABLE_EMMC_TRIM) {
				MMCINFO("disable emmc trim feature.\n");
				cfg->platform_caps.drv_wipe_feature |=
				    DRV_PARA_DISABLE_EMMC_TRIM;
			}
		}

		/* ret = script_parser_fetch("card0_boot_para", "sdc_erase",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_erase",
				      (uint32_t *)(&rval));
		if (ret < 0)
			...
			if (rval & DRV_PARA_DISABLE_EMMC_ERASE) {
				...
				cfg->platform_caps.drv_erase_feature |=
				    DRV_PARA_DISABLE_EMMC_ERASE;
			}
			if (rval & DRV_PARA_ENABLE_EMMC_SANITIZE_WHEN_ERASE) {
				MMCINFO("enable emmc sanitize when erase.\n");
				cfg->platform_caps.drv_erase_feature |=
				    DRV_PARA_ENABLE_EMMC_SANITIZE_WHEN_ERASE;
			}
		}

		/* ret = script_parser_fetch("card0_boot_para", "sdc_boot",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_boot",
				      (uint32_t *)(&rval));
		if (ret < 0)
			...
			if (rval & DRV_PARA_NOT_BURN_USER_PART) {
				...
				cfg->platform_caps.drv_burn_boot_pos |=
				    DRV_PARA_NOT_BURN_USER_PART;
			}
			if (rval & DRV_PARA_BURN_EMMC_BOOT_PART) {
				MMCINFO("burn boot0 to emmc boot part.\n");
				cfg->platform_caps.drv_burn_boot_pos |=
				    DRV_PARA_BURN_EMMC_BOOT_PART;
			}
		}

		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_odly_50M",
				      (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_sdly_50M",
				      (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_odly_50M_ddr", (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_sdly_50M_ddr", (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_freq",
				      (uint32_t *)(&rval));
		if (ret < 0) {
			...
			MMCINFO("get sdc0 sdc_freq %d.%d\n", rval,
				cfg->platform_caps.boot_hs_f_max);
		}

		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_b0p",
				      (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_ex_dly_used", (uint32_t *)(&rval));
		if (ret < 0) {
			MMCDBG("get card0_boot_para:sdc_ex_dly_used fail\n");
		} else {
			if (rval == 1) { /* maual sample point from fex */
				cfg->platform_caps.sample_mode =
				    MAUNAL_SAMPLE_MODE;
				MMCINFO("get sdc_ex_dly_used %d, use manual "
					"sdly in fex\n",
					rval);
			} else {
		...
		if (cfg->platform_caps.sample_mode == MAUNAL_SAMPLE_MODE) {
			for (imd = 0; imd < MAX_SPD_MD_NUM; imd++) {
				for (ifreq = 0; ifreq < MAX_CLK_FREQ_NUM;
				     ifreq++) {
					sprintf(ctmp, "sdc_odly_%d_%d", imd,
						ifreq);
					ret = fdt_getprop_u32(
					    working_fdt, nodeoffset, ctmp,
					    (uint32_t *)(&rval));
					if (ret < 0) {
					...
					sprintf(ctmp, "sdc_sdly_%d_%d", imd,
						ifreq);
					ret = fdt_getprop_u32(
					    working_fdt, nodeoffset, ctmp,
					    (uint32_t *)(&rval));
		...
		nodeoffset =
		    fdt_path_offset(working_fdt, FDT_PATH_CARD2_BOOT_PARA);
		if (nodeoffset < 0) {
			MMCINFO("get card0 para fail\n");
			return;
		}
		 ...
		 * *)(0x1c20848), *(volatile u32 *)(0x1c2084C), *(volatile u32
		 * *)(0x1c20850)); */

		/* ret = script_parser_fetch("card2_boot_para", "sdc_wipe",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_wipe",
				      (uint32_t *)(&rval));
		if (ret < 0)
		...
		/* ret = script_parser_fetch("card2_boot_para", "sdc_erase",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_erase",
				      (uint32_t *)(&rval));
		if (ret < 0)
		...
		/* ret = script_parser_fetch("card2_boot_para", "sdc_boot",
		 * &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_boot",
				      (uint32_t *)(&rval));
		if (ret < 0)
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_wp",
				      (uint32_t *)(&rval));
		if (ret < 0)
			...
			if (rval & DRV_PARA_ENABLE_EMMC_USER_PART_WP) {
				...
				cfg->platform_caps.drv_wp_feature |=
				    DRV_PARA_ENABLE_EMMC_USER_PART_WP;
			}
		}

		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_hc_cap_unit", (uint32_t *)(&rval));
		if (ret < 0)
			MMCINFO("get sdc2 sdc_hc_cap_unit fail.\n");
		else {
			if (rval & DRV_PARA_ENABLE_EMMC_USER_PART_WP) {
				MMCINFO("enable emmc high "
					"capacity-erase/high-capacity write "
					"protect unit size.\n");
				cfg->platform_caps.drv_hc_cap_unit_feature |=
				    DRV_PARA_ENABLE_EMMC_HC_CAP_UNIT;
			}
		}

		ret =
		    fdt_getprop_u32(working_fdt, nodeoffset,
				    "sdc_cal_delay_unit", (uint32_t *)(&rval));
		if (ret < 0)
		...
		/* ret = script_parser_fetch("card2_boot_para",
		 * "sdc_ex_dly_used", &rval, 1); */
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_ex_dly_used", (uint32_t *)(&rval));
		if (ret < 0) {
			...
			memset(
			    mmchost->cfg.platform_caps.sdly.tm4_smx_fx, 0xff,
			    sizeof(mmchost->cfg.platform_caps.sdly.tm4_smx_fx));
		}
		/* ret1 = script_parser_fetch("mmc2_para", "sdc_ex_dly_used",
		 * &rval_ker, 1); */
		/* if (ret1 < 0) */
		...
		if (!(ret < 0)) {
			...
			u32 *p = (u32 *)&mmchost->cfg.platform_caps.sdly
				     .tm4_smx_fx[0];

			if ((rval ==
			     2)) { /* only when kernal use auto sample,uboot
				      will use auto sample. */
				cfg->platform_caps.sample_mode =
				    AUTO_SAMPLE_MODE;
				MMCINFO("get sdc_ex_dly_used %d, use auto "
					"tuning sdly\n",
					rval);
				if (work_mode != WORK_MODE_BOOT) {
					/*usb product will auto get sample
					 * point, no need to get auto sdly, so
					 * first used default value*/
					MMCINFO("current is product mode, it "
						"will tune sdly later\n");
				} else {
					/* copy sample point cfg from uboot
					 * header to internal variable */
					if (((priv_info->ext_para0 &
					      0xFF000000) == EXT_PARA0_ID) &&
					    (priv_info->ext_para0 &
					     EXT_PARA0_TUNING_SUCCESS_FLAG)) {
						if (sdly != NULL)
							memcpy(
							    p, sdly,
							    sizeof(struct
						...
						memset(
						    p, 0xFF,
						    sizeof(struct tune_sdly));
						MMCINFO("get sdly from uboot "
							"header fail\n");
					}
				}
			} else if (rval ==
				   1) { /* maual sample point from fex */
				cfg->platform_caps.sample_mode =
				    MAUNAL_SAMPLE_MODE;
				MMCINFO("get sdc_ex_dly_used %d, use manual "
					"sdly in fex\n",
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_force_boot_tuning",
				      (uint32_t *)(&rval));
		if (ret < 0)
			MMCDBG(
			    "get card2_boot_para:sdc_force_boot_tuning fail\n");
		else {
			if (rval == 1) {
				MMCINFO("card2 force to execute tuning during "
					"boot.\n");
				cfg->platform_caps.force_boot_tuning = 1;
			} else {
				MMCDBG("card2 don't force to execute tuning "
				       "during boot.\n");
		...
		ret = fdt_getprop_u32(working_fdt, nodeoffset, "sdc_tm4_win_th",
				      (uint32_t *)(&rval));
		if (ret < 0) {
		...
		for (i = 0; i < MAX_EXT_FREQ_POINT_NUM; i++) {
			...
			ret = fdt_getprop_u32(working_fdt, nodeoffset, ctmp,
					      (uint32_t *)(&rval));
			if (ret < 0) {
				...
				if ((rval & 0xff) >= 25)
					cfg->platform_caps
					    .tm4_tune_ext_freq[i] = rval;
				else {
					cfg->platform_caps
					    .tm4_tune_ext_freq[i] = 0x0;
					MMCINFO("invalid freq %d MHz, discard "
						"this ext freq point\n",
						(rval & 0xff));
				}
			}
		...
		/* speed mode caps */
		ret = fdt_getprop_u32(working_fdt, nodeoffset,
				      "sdc_dis_host_caps", (uint32_t *)(&rval));
		if (ret < 0) {
		...
		ret =
		    fdt_getprop_u32(working_fdt, nodeoffset,
				    "sdc_kernel_no_limit", (uint32_t *)(&rval));
		if (ret < 0) {
			MMCDBG("get sdc2 sdc_kernel_no_limit fail.\n");
			cfg->platform_caps.tune_limit_kernel_timing = 0x1;
		} else {
			if (rval == 1)
				cfg->platform_caps.tune_limit_kernel_timing =
				    0x0;
			else
				cfg->platform_caps.tune_limit_kernel_timing =
				    0x1;
			MMCINFO(
			    "get sdc2 sdc_kernel_no_limit 0x%x, limit 0x%x.\n",
...
int sunxi_mmc_init(int sdc_no)
{
	...
	if ((sdc_no == 2)) {
		...
		host->cfg.platform_caps.odly_spd_freq =
		    &ext_odly_spd_freq_sdc0[0];
		host->cfg.platform_caps.sdly_spd_freq =
		    &ext_sdly_spd_freq_sdc0[0];
	}
	...
	host->cfg.voltages = MMC_VDD_32_33 | MMC_VDD_33_34 | MMC_VDD_27_28 |
			     MMC_VDD_28_29 | MMC_VDD_29_30 | MMC_VDD_30_31 |
			     MMC_VDD_31_32 | MMC_VDD_34_35 | MMC_VDD_35_36;
	...
	if (host->cfg.platform_caps.host_caps_mask) {
		...
		if (mask & DRV_PARA_DISABLE_MMC_MODE_HS_52MHz)
			host->cfg.host_caps &=
			    (~(DRV_PARA_DISABLE_MMC_MODE_HS_52MHz |
			       DRV_PARA_DISABLE_MMC_MODE_DDR_52MHz |
			       DRV_PARA_DISABLE_MMC_MODE_HS400 |
			       DRV_PARA_DISABLE_MMC_MODE_HS200));
		if (mask & DRV_PARA_DISABLE_MMC_MODE_8BIT)
			host->cfg.host_caps &=
			    (~(DRV_PARA_DISABLE_MMC_MODE_8BIT |
			       DRV_PARA_DISABLE_MMC_MODE_HS400));

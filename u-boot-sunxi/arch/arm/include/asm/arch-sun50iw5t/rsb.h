...
#define ERR_TRANS_1ST_BYTE                                                     \
	(0x1) /* error happened with the transmission of the 1st byte of data  \
		 */
#define ERR_TRANS_2ND_BYTE                                                     \
	(0x2) /* error happened with the transmission of the 2nd byte of data  \
		 */
#define ERR_TRANS_3RD_BYTE                                                     \
	(0x4) /* error happened with the transmission of the 3rd byte of data  \
		 */
#define ERR_TRANS_4TH_BYTE                                                     \
	(                                                                      \
	    0x8) /*  error happened with the transmission of the 4th byte of   \
		    data */
#define ERR_TRANS_RT_NO_ACK                                                    \
	(0x1 << 8) /* no ack when set runtime slave address. */

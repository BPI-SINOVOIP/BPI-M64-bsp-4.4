...
#define GIC_CON_IGRP(n) (ARMV7_GIC_BASE + 0x0080 + (n)*4)
...
#define GIC_SGI_PEND_SET(_n) (ARMV7_GIC_BASE + 0xf10 + 4 * (_n))
...
#define GIC_AIAR_REG (ARMV7_CPUIF_BASE + 0x020)		/*  0x8020 */
#define GIC_AEOI_REG (ARMV7_CPUIF_BASE + 0x024)		/*  0x8024 */
#define GIC_AHIGHEST_PENDINT (ARMV7_CPUIF_BASE + 0x028) /*  0x8028 */

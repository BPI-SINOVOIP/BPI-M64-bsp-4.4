...
#define MMC_MODE_HS_52MHz                                                      \
	(1 << 1) /* can run at 52MHz with SDR mode -- HSSDR52_SDR25 */
#define MMC_MODE_4BIT (1 << 2)
#define MMC_MODE_8BIT (1 << 3)
#define MMC_MODE_SPI (1 << 4)
#define MMC_MODE_HC (1 << 5)
#define MMC_MODE_DDR_52MHz                                                     \
	(1 << 6) /* can run at 52Mhz with DDR mode -- HSDDR52_DDR50 */
#define MMC_MODE_HS200                                                         \
	(1 << 7) /* can run at 200/208MHz with SDR mode -- HS200_SDR104*/
...
#define EXT_CSD_CARD_TYPE_DDR_1_8V                                             \
	(1 << 2) /* Card can run at 52MHz */ /* DDR mode @1.8V or 3V I/O */
#define EXT_CSD_CARD_TYPE_DDR_1_2V                                             \
	(1 << 3) /* Card can run at 52MHz */ /* DDR mode @1.2V I/O */
...
#define EXT_CSD_CARD_TYPE_HS200_1_2V                                           \
	(1 << 5) /* Card can run at 200MHz */ /* SDR mode @1.2V I/O */
...
#define CARD_TYPE_NULL 0xffffffff
	u32 card_type; /*0xffffffff: invalid; 0x8000000: mmc card; 0x8000001: sd
			  card*/

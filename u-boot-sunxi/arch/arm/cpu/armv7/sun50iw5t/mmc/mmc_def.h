...
/* #define readb(addr)		(*((volatile unsigned char  *)(addr)))
 ...
 #define writeb(v, addr)	(*((volatile unsigned char  *)(addr)) = (unsigned
 char)(v))
 #define writew(v, addr)	(*((volatile unsigned short *)(addr)) = (unsigned
 short)(v))
 #define writel(v, addr)	(*((volatile unsigned long  *)(addr)) = (unsigned
 long)(v)) */
...
#define DRIVER_VER "2018-04-08 14:50"

...
/* define the sector count of a super physical page, the super page may be based
 * on multi-plane */
...
/* define the count of the total nand flash bank in the nand flash storage
 * system */
...
/* sync bank with bank mode, only check the status of the bank to wait bank
 * ready */
...
*
*Arguments  : pBlkAdr   the parameter of the physical block which need be
*erased.
*
...
*
*Description: copy one physical page from one physical block to another physical
*block.
*
*Arguments  : pSrcPage      the parameter of the source page which need be
*copied;
*             pDstPage      the parameter of the destination page which copied
*to.
*

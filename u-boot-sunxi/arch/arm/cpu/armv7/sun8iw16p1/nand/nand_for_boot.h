...
typedef struct {
	...
	__u32 RbCnt;
	__u32
	    RbConnectInfo;   /*the connect  information of the all rb  chips are
				connected*/
	...
	__u32
	    BlkCntPerDie; /*the count of the physic blocks in one die, include
			     valid block and invalid block*/
	__u32
	    OperationOpt;   /*the mask of the operation types which current nand

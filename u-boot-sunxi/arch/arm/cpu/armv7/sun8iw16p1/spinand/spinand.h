...
#define NAND_TWO_PLANE_SELECT                                                  \
	(1 << 7) /*nand flash need plane select for                            \
		    addr*/
#define NAND_ONEDUMMY_AFTER_RANDOMREAD                                         \
	(1 << 8) /*nand flash need a dummy Byte after random fast read*/

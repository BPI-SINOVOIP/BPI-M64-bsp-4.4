...
#ifdef CONFIG_SUN8IW8P1_NOR
#define CONFIG_TARGET_NAME      spinor-sun8iw8p1
#else
...
//fdt addr for kernel
#define CONFIG_SUNXI_FDT_ADDR               (CONFIG_SYS_SDRAM_BASE+0x03100000)
...
#define PHYS_SDRAM_1_SIZE           (64 << 20)              /* 0x20000000, 512 MB Bank #1 */

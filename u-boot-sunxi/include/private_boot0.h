...
typedef struct _boot0_private_head_t
{
    ...
    /*card 0:offest 0, card 1: offest 8, card 2: offest 16 card 3:offest 24
     *defualt use card 0 & 2, other may be have problem,
     *Please refer to brandy/pack_tools/update_boot0
     */
